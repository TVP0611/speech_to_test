...
def _download_and_preprocess_data(data_dir):
    ...
    # urllib.request.urlretrieve(download_file_url, file_path)

    train_clean_100 = urllib.request.urlretrieve(TRAIN_CLEAN_100_URL, data_dir)
    train_clean_360 = urllib.request.urlretrieve(TRAIN_CLEAN_360_URL, data_dir)
    train_other_500 = urllib.request.urlretrieve(TRAIN_OTHER_500_URL, data_dir)

    dev_clean = urllib.request.urlretrieve(DEV_CLEAN_URL, data_dir)
    dev_other = urllib.request.urlretrieve(DEV_OTHER_URL, data_dir)

    test_clean = urllib.request.urlretrieve(TEST_CLEAN_URL, data_dir)
    test_other = urllib.request.urlretrieve(TEST_OTHER_URL, data_dir)
...
if __name__ == "__main__":
    _download_and_preprocess_data("D:/train_model_speech_to_test/speech_to_text/process_voice_classify/record_audio/ctc-master/data_dir")
