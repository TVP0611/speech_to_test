...
class CrfTokenizer(BaseTokenizer):
    def __init__(self, config_root_path="", bi_grams_path='tokenization/bi_grams.txt', tri_grams_path='tokenization/tri_grams.txt',
                 crf_config_path='tokenization/crf_config.txt',
                 features_path='tokenization/crf_features.txt',
                 model_path='tokenization/vi-segmentation.crfsuite',
