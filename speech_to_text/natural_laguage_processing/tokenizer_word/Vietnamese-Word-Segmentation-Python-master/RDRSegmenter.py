...
if __name__ == "__main__":
    ...
    tokenizer = Tokenizer()
    t=time.time()
    output = rdrsegment.segmentRawSentences(tokenizer,"bắt đầu tham quan")#"Lượng khách Thái bắt đầu gia tăng từ đầu năm 2005. Bên cạnh đó, kể từ tháng 10-2005 đến nay, từ khi được phép của VN, các đoàn caravan của Thái Lan cũng đã ồ ạt đổ vào VN.")
